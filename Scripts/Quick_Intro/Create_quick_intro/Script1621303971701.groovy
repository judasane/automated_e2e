...
WebUI.waitForElementPresent(findTestObject('Page_Contacts_Dashboard/Contact_Tittle'), 10)

WebUI.mouseOver(findTestObject('Page_Contacts_Dashboard/Main_Contact_Row'))

WebUI.verifyElementClickable(findTestObject('Page_Contacts_Dashboard/Start_Quick_Intro_Button'))

WebUI.click(findTestObject('Page_Contacts_Dashboard/Start_Quick_Intro_Button'))

WebUI.verifyElementPresent(findTestObject('Page_Quick_Intro/Page_On My Radar/Section_Main_Contact'), 10)

WebUI.verifyElementPresent(findTestObject('Page_Quick_Intro/Page_On My Radar/Section_Select_Contacts'), 5)

WebUI.verifyElementPresent(findTestObject('Page_Quick_Intro/Page_On My Radar/Section_Short_Message_For_Recipient'), 5)
